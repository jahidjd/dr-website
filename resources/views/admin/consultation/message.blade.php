                        ...
                        <section class="col-lg-12 connectedSortable">
                            ...
                            <div class="card ">
                                <div class="card-header">
                                    <h2 class="card-title">Add Consaltation PopUp Message</h2>
                                  </div>
                                
                                <form action="{{route('consultationPopupAdd')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                      
                                      <div class="form-group">
                                        <label for="exampleInputEmail1">Message</label>
                                        <textarea name="message" id="" cols="15" rows="5" class="form-control">{{old('message')}}</textarea>
                                        @error('message')
