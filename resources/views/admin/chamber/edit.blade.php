        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Chamber Update</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Chamber Update</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <section class="col-lg-12 connectedSortable">
                            ...
                            <div class="card ">
                                <div class="card-header">
                                    <h2 class="card-title">Chamber Update</h2>
                                </div>

                                <form action="{{route('chambers.update',$cham->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" id="" cols="15" rows="3"
                                                        class="form-control">{{$cham->address}}</textarea>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="mobile" class="form-control" value="{{$cham->mobile}}">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" class="form-control" value="{{$cham->email}}">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="workday_from" id="" class="form-control">
                                                        <option value="{{$cham->workday_from}}">{{$cham->workday_from}}</option>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="workday_end" id="" class="form-control">
                                                        <option value="{{$cham->workday_end}}">{{$cham->workday_end}}</option>
                                                        <option value="Sat">Saturday</option>
                                                        <option value="Sun">Sunday</option>
                                                        <option value="Mon">Monday</option>
                                                        <option value="Tue">Tuesday</option>
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="time_from" class="form-control" value="{{$cham->time_from}}">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="time_end" class="form-control" value="{{$cham->time_end}}">
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="work_day_single" id="" class="form-control">
                                                        <option value="{{$cham->work_day_single}}">{{$cham->work_day_single}}</option>
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="work_time_single_start"
                                                        class="form-control" value="{{$cham->work_time_single_start}}">
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                                <div class="form-group">
                                                    <label for="details">Time End</label>
                                                    <input type="time" name="work_time_single_end" class="form-control" value="{{$cham->work_time_single_end}}">
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                                    ...
                                                    <select name="off_day" id="" class="form-control">
                                                        <option value="{{$cham->off_day}}">{{$cham->off_day}}</option>
                                                        <option value="Saturday">Saturday</option>
                                                        <option value="Sunday">Sunday</option>
                                                        <option value="Monday">Monday</option>
                                                        <option value="Tuesday">Tuesday</option>
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                                    ...
                                                    <select name="status" id="" class="form-control">
                                                        <option value="{{$cham->status}}">{{$cham->status}}</option>
