                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Projects Update</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-12 connectedSortable">
                            ...
                            <div class="card ">
                                ...
                                <form action="{{route('project.update',$pro->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                   @method('put')
                                    <div class="card-body">
                                      <div class="form-group">
                                        <label for="exampleInputEmail1">Title</label>
                                        <input type="text" class="form-control" value="{{$pro->title}}" id="exampleInputEmail1" name="title">
                                      </div>
                                      <div class="form-group">
                                        <label for="details">Details</label>
                                        <textarea name="details" id="" cols="15" rows="5" class="form-control">{{$pro->details}}</textarea>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="input-group">
                                          <div class="custom-file">
                                            ...
                                            <img src="{{url('admin/img/project',$pro->image)}}" alt="" height="150px">
                                          </div>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                         ...
                                         <tbody>
                                           ...
                                           <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('deleteTop',$v->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
