                                ...
                                <form action="{{route('testimonial.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{old('insta_link')}}" id="exampleInputEmail1" name="insta_link" placeholder="Optional">
                                      </div>
                                      <div class="form-group">
                                        <label for="details">Facebook Link</label>
                                        <input type="text" class="form-control" value="{{old('fb_link')}}" id="exampleInputEmail1" name="fb_link" placeholder="Optional">
                                      </div>
                                      <div class="form-group">
                                        <label for="details">Twitter Link</label>
                                        <input type="text" class="form-control" value="{{old('trt_link')}}" id="exampleInputEmail1" name="trt_link" placeholder="Optional">
                                      </div>
                                      <div class="form-group">
                                        <label for="details">LinkedIn Link</label>
                                        <input type="text" class="form-control" value="{{old('lnkd_link')}}" id="exampleInputEmail1" name="lnkd_link" placeholder="Optional">
                                      </div>
