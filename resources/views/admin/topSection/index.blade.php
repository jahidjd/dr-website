                        ...
                        <section class="col-lg-12 connectedSortable">
                            ...
                            <div class="card ">
                                <div class="card-header">
                                    <h2 class="card-title">Top Section</h2>
                                  </div>
                                
                                <form action="{{route('addTop')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                      ...
                                      <table class="table table-bordered">
                                         ...
                                         <tbody>
                                           ...
                                           <tr>
                                            ...
                                            <td>{{$v->status}}</td>
                                            <td>
                                                <a href="{{route('editTop',$v->id)}}"  class="btn" style="color: green"><i class="fa-solid fa-pen-to-square"></i></a>
