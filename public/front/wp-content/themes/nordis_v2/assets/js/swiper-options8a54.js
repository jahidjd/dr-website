(function( $ ) {
    ...
    $.fn.NordisSwiper = function( options ) {
        var defaults = {};
        ...
        this.each( function() {
            ...
            var $sliderContainer = $slider.find( '.swiper-container' ),
                ...
                mdBreakPoint = nordis_swiper_options.md ? nordis_swiper_options.md : 768,
                lgBreakPoint = nordis_swiper_options.lg ? nordis_swiper_options.lg : 1025;
            ...
            $( document ).trigger( 'NordisSwiperInit', [ $swiper, $slider, swiperOptions ] );
        } );
