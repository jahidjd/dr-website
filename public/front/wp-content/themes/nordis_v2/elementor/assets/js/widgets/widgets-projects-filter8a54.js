( function( $ ) {
        ...
        var NordisProjectsFilterHandler = function( $scope, $ ) {
        ...
        $( window ).on( 'elementor/frontend/init', function() {
            elementorFrontend.hooks.addAction( 'frontend/element_ready/nordis-projects-extended-carousel.default', NordisProjectsFilterHandler );
        } );
    }
